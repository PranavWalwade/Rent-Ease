...
//
//	        // Fetch and set User
//	        User user = userRepository.findById(propertyDTO.getUserid()).orElseThrow(
//	                () -> new RuntimeException("User not found")
//	        );
//	        property.setUserid(user);
//
//	        // Fetch and set Area
//	        Area area = areaRepository.findById(propertyDTO.getAreaid()).orElseThrow(
//	                () -> new RuntimeException("Area not found")
//	        );
//	        property.setAreaid(area);
//
//	        // Fetch and set Furnish Type
//	        Furnished furnished = furnishedRepository.findById(propertyDTO.getFurnishid()).orElseThrow(
//	                () -> new RuntimeException("Furnish Type not found")
//	        );
//	        property.setFurnishid(furnished);
//
//	        // Fetch and set Property Type
//	        Propertytype propertyType = propertyTypeRepository.findById(propertyDTO.getPropertytypeid()).orElseThrow(
//	                () -> new RuntimeException("Property Type not found")
//	        );
